...
@Composable
fun LaporanDetailPendapatanCard(item: DetailPendapatan) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .wrapContentHeight(),
        ...
        Column(
            ...
            Text(text = "Nama Customer: ${item.namaCustomer}", style = MaterialTheme.typography.body2)
            Text(text = "Nama Mobil: ${item.namaMobil}", style = MaterialTheme.typography.body2)
            Text(text = "Jenis Transaksi: ${item.jenisTransaksi}", style = MaterialTheme.typography.body2)
            Text(text = "Jumlah Transaksi: ${item.jumlahTransaksi}", style = MaterialTheme.typography.body2)
            Text(
